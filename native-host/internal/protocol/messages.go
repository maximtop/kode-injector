...
const (
	...
	ErrorAuthorizationCancelled      ErrorCode = "AUTHORIZATION_CANCELLED"
	ErrorAuthorizationTargetNotFound ErrorCode = "AUTHORIZATION_TARGET_NOT_FOUND"
	ErrorAuthorizationFailed         ErrorCode = "AUTHORIZATION_FAILED"
	ErrorFileChanged                 ErrorCode = "FILE_CHANGED"
