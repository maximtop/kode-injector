 ...
 */
export const GECKO_ID = 'kode-injector@maximtop.dev';
 ...
 */
export const AMO_APPROVAL_NOTES_SUMMARY = 'Injects JavaScript and CSS from local files into the '
    + 'websites the user maps them to. The files are read through Kode Injector Helper, a '
    + 'separately installed read-only native messaging application. No extension account, no '
    + 'remote code, no network requests.';
